...
format long;
Nv=3; Nc=2; No=10000; Dx=1;eta=3.5;
...
U1=13*U1; % only for drawing
U2=13*U2; % only for drawing
figure(1)
plot3(YRNW1(1, :), YRNW1(2, :),YRNW1(3, :), 'b.'); hold on;
...
figure(2)
plot3(YRNW2(1, :), YRNW2(2, :),YRNW2(3, :), 'r+'); hold on;
...
figure(3)
plot3(YRNW1(1, :), YRNW1(2, :),YRNW1(3, :), 'b.'); hold on;
plot3(YRNW2(1, :), YRNW2(2, :),YRNW2(3, :), 'r+'); 
