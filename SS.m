% test the pdf of SS embedding
clear all; close all; clc
format long;
Nv=3; Nc=2; No=10000; alpha=6; Dx=1;
...
figure(1)
plot3(YSS1(1, :), YSS1(2, :),YSS1(3, :), 'b.'); hold on;
...
figure(2)
plot3(YSS2(1, :), YSS2(2, :),YSS2(3, :), 'r+'); hold on;
